...
class NonContiguousContextExp1(InputFeatures):
...
class NonContiguousContextExp3(InputFeatures):
...
class NonContiguousContextExp4(InputFeatures):
...
processors_dynamic_context_non_contiguous = {
    ...
    "exp1": NonContiguousContextExp1,
    "exp2": NonContiguousContextExp2,
    "exp3": NonContiguousContextExp3,
    "exp4": NonContiguousContextExp4,
